            ...
            try
            {
                ...
                else
                {
                    ...
                    {//txtTenDangNhap.Text, txtMatKhau.Text
                        ...
                        TaiKhoanDTO TaiKhoan = TaiKhoanDTO.getInstanceinforUer();
                        TaiKhoan.userID = txtTenDangNhap.Text;
                        TaiKhoan.password = txtMatKhau.Text;
                        ds = bll.DangNhap(ref error, TaiKhoan);
                        ...
                        if (kt > 0)
                        {
                            ...
                            checkAdmin checkQuyen = new ProxyKiemTraAdmin();
                            int x = checkQuyen.KiemTraAdmin(quyen);
                            if(x == 1)
                            {
                            ...
                            {
                                MessageBox.Show("Xin Chao Nhan Vien");
                            }
                            if(quyen>0)
                            {
