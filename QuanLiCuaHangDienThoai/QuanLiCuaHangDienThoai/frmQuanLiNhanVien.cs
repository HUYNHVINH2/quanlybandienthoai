               ...
               if(ktcmnd)
                {
                    try
                    {
                        if (them)
                        {
                            ...
                            ThongtinNhanVien.TenNV = tennv;
                            ThongtinNhanVien.DiaChi = diachi;
                            ThongtinNhanVien.Email = email;
                            ThongtinNhanVien.SDT = sdt;

                            kt = nhanvienbll.ThemNhanVien(ref error, ThongtinNhanVien);
                            if (kt)
                            {
                        ...
                        else
                        {
                            ...
                            NhanVienDTO ThongtinNhanVien = new NhanVienDTO();
                            ThongtinNhanVien.IDNV = idnv;
                            ThongtinNhanVien.TenNV = tennv;
                            ThongtinNhanVien.DiaChi = diachi;
                            ThongtinNhanVien.Email = email;
                            ThongtinNhanVien.SoChungMinh = cmnd;
                            ThongtinNhanVien.SDT = sdt;
                            kt = nhanvienbll.SuaNhanVien(ref error,ThongtinNhanVien);
                            if (kt)
                            {
